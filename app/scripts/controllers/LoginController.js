 ...
 */
 ...
 .factory('Auth',['$http','$cookieStore','$rootScope',function($http,$cookieStore,$rootScope){
   ...
   service.login = function(username, password, callback)
   {
     ...
     var responsetrue = {success:true};
     var responsefalse = {success:false}
     $http.defaults.headers.common = {'X-User' : username , 'X-Token': password};

     $http({url: url}).then(function (res) {
    ...
    service.ClearCredentials = function() {
      ...
      $http.defaults.headers.common = {'X-User' : " ", 'X-Token' : " "};
