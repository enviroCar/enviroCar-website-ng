...
angular.module('angularMaterialAdmin', ['ngAnimate', 'ngCookies',
  'ngSanitize', 'ui.router', 'ngMaterial', 'nvd3','angular-timeline','infinite-scroll','angularUtils.directives.dirPagination','angular-loading-bar','leaflet-directive','angular.img','app'])
  ...
  .config(function ($stateProvider, $urlRouterProvider, $mdThemingProvider,
    ...
    $stateProvider
      ...
      .state('home.error',{
       templateUrl:function (stateParams){
       return 'app/views/error.html?path='+stateParams.path+'&status='+stateParams.status},
