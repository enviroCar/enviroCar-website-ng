angular.module('app')
.controller('MyActivityController',['$scope','$http','$rootScope','$state',function($scope,$http,$rootScope,$state){

  console.log("My activity fired");
  $scope.events = [];
  var eventshelper = []
  $scope.busy = false;
  $scope.page = 0;
  ...
  $scope.nextpage = function (){
    ...
    $scope.page++;
    $scope.busy = true;
    var url = "https://envirocar.org/api/stable/users/"+$rootScope.globals.currentUser.username+"/activities?";
