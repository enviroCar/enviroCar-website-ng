...
.controller('FriendActivityController',['$scope','$http','$rootScope','$state','friendactivity',function($scope,$http,$rootScope,$state,friendactivity){
  ...
  $scope.nextpage = function (){
      $scope.page++;
      var url = friendactivity.url_base + $rootScope.globals.currentUser.username + friendactivity.friend;
