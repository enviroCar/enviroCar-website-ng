angular.module('app')
.controller("filterTracksController",['$scope','$rootScope','$http','$stateParams','$state','$mdDialog','$mdMedia','tracks_calendar',function($scope,$rootScope,$http,$stateParams,$state,$mdDialog,$mdMedia,tracks_calendar){
  ...
  $http.get(url).then(function(data){
    ...
    for(var i = 0 ; i < data.data.tracks.length ; i++)
    {
      ...
      track_helper['Distance'] = data.data.tracks[i]['length'].toFixed(2);
