...
angular.module('app')
  ...
  .controller('ProfileViewController', ['$scope', '$rootScope', '$http',
    ...
    function($scope, $rootScope, $http, ProfileViewFactory, profileview) {
      ...
      var url_track = profileview.url_base + $rootScope.globals.currentUser.username +
        profileview.tracks;
      ...
      var url_friends_number = profileview.url_base + $rootScope.globals.currentUser
        .username + profileview.friends;
      ProfileViewFactory.get(url_friends_number).then(function(data) {
        ...
        */
      var url_groups = profileview.url_base + $rootScope.globals.currentUser.username +
        profileview.groups;
